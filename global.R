...
death_self_loop_m <- readRDS(here::here("data/death2_snape_self_loop_m_v2.rds"))
deatheaters_rel <- readRDS(here::here("data/death2_snape_net_rel_v2.rds"))
...
death_net <- readRDS(here::here("data/death_net.rds"))
